import 'package:crud_version1/message_response.dart';
import 'package:crud_version1/modify_contac.dart';
import 'package:crud_version1/register_contact.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => RegisterContact())).then((newContact){
            if(newContact != null){
              setState(() {
  ...
  removeClient(BuildContext context, Client client){
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Text("Está seguro de elmimar a "+client.name+"?"),
        actions: [
          TextButton(
            onPressed: () {
              setState(() {
